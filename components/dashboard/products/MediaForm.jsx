...
export default function MediaForm({ formData, images, fileInputRef, handleImageUpload, removeImage, addTag, removeTag, currentTag, setCurrentTag }) {
    ...
    return (
        <div className={`space-y-6`}>
            <div>
                <label className={`dashboard-form-label mb-4`}>Product Images</label>
                ...
                <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4`}>
                    ...
                    >
                        <div className={`text-center`}>
                            <PhotoIcon className={`size-8 mx-auto mb-2`}/>
            ...
            <div>
                <label className={`dashboard-form-label mb-2`}>Tags</label>
