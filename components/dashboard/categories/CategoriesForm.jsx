            ...
            <div className={`bg-gray-800 rounded-lg border border-gray-700 p-6`}>
                    ...
                    <div className={`grid grid-cols-1 gap-6`}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors duration-200 ${
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-3 py-2 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors duration-200 resize-none border-gray-600`}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-3 py-2 bg-gray-700 border rounded-lg text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors duration-200 ${
                                    errors.parent_id ? 'border-red-500' : 'border-gray-600'
                                }`}
                            >
                                <option value="">Select a parent category (optional)</option>
                                {categories
                                    .filter(cat => !isEditing || cat.id !== parseInt(params.id))
                                    .map((category) => (
                        ...
                        {imagePreview ? (
                            ...
                            <div className="border-2 border-dashed border-gray-600 rounded-lg p-8">
                                <div className="text-center">
                                    <HiOutlinePhoto className="h-12 w-12 text-gray-400 mx-auto mb-4"/>
                                    ...
                                    <label className="cursor-pointer">
                                        <span
                                            ...
                                            <HiOutlineCloudArrowUp className="h-5 w-5 mr-2"/>
                                            Upload Image
                                        </span>
                                        <input
                                            type="file"
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {/* Sort Order */}
                        <div>
                            <label htmlFor="sort_order" className="block text-sm font-medium text-gray-300 mb-2">
                                Sort Order
                            </label>
                            <input
                                type="number"
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-3 py-2 bg-gray-700 border rounded-lg text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors duration-200 ${
                                    errors.sort_order ? 'border-red-500' : 'border-gray-600'
                                }`}
                            />
                            {errors.sort_order && (
