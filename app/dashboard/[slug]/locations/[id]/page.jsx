                  ...
                  <span
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-white mb-3 flex items-center">
                                        <HiOutlineMapPin className="h-5 w-5 mr-2 text-teal-400"/>
                                        Address
                                    </h3>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center text-gray-300">
                                            <HiOutlinePhone className="h-5 w-5 mr-3 text-teal-400"/>
                                        ...
                                        <div className="flex items-center text-gray-300">
                                            <HiOutlineEnvelope className="h-5 w-5 mr-3 text-teal-400"/>
                        ...
                        {location.settings?.operating_hours && (
                            <div className="bg-gray-800 rounded-lg p-6">
                                <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                                    <HiOutlineClock className="h-5 w-5 mr-2 text-teal-400"/>
                                    Operating Hours
                                </h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {location.settings.features.map((feature, index) => (
                                        <div key={index} className="flex items-center py-2 px-3 bg-gray-700 rounded">
                                            <HiOutlineCheckCircle className="h-4 w-4 mr-3 text-green-400"/>
                    ...
                    <div className="space-y-6">
                        ...
                        {location.manager_name && (
                            <div className="bg-gray-800 rounded-lg p-6">
                                <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                                    <HiOutlineUser className="h-5 w-5 mr-2 text-teal-400"/>
                                    Manager
                                </h3>
                                <div className="space-y-3">
                                    <div>
                        ...
                        <div className="bg-gray-800 rounded-lg p-6">
                            <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                                <HiOutlineCalendar className="h-5 w-5 mr-2 text-teal-400"/>
                                Metadata
                            </h3>
